...
const char *orchestrator_event_name(orchestrator_event_t event)
{
    ...
    case ORCH_EVENT_NETDISCOVERY_COMPLETE:   return "ORCH_EVENT_NETDISCOVERY_COMPLETE";
    case ORCH_EVENT_NETDISCOVERY_TIMEOUT:    return "ORCH_EVENT_NETDISCOVERY_TIMEOUT";
